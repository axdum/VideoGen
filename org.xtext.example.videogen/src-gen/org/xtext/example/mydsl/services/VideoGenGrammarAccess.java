...
public class VideoGenGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class VideoGeneratorModelElements extends AbstractParserRuleElementFinder {
		...
		//{VideoGeneratorModel} information=VideoGenInformation? 'VideoGen' LEFT_BRACKET medias+=Media+ RIGHT_BRACKET
	...
	public class TextElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cSizeAssignment_7 = (Assignment)cGroup.eContents().get(7);
		private final RuleCall cSizeINTTerminalRuleCall_7_0 = (RuleCall)cSizeAssignment_7.eContents().get(0);
		private final RuleCall cRIGHT_BRACKETTerminalRuleCall_8 = (RuleCall)cGroup.eContents().get(8);
		
		//Text:
		//	LEFT_BRACKET
		//	'content' content=STRING
		//	'position' position=Position ('color' color=STRING)?
		//	'size' size=INT
		//	RIGHT_BRACKET;
		@Override public ParserRule getRule() { return rule; }
		...
		//size=INT
		public Assignment getSizeAssignment_7() { return cSizeAssignment_7; }
		
		//INT
		public RuleCall getSizeINTTerminalRuleCall_7_0() { return cSizeINTTerminalRuleCall_7_0; }
