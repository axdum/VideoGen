...
public class InternalVideoGenLexer extends Lexer {
    ...
    public final void mT__40() throws RecognitionException {
        try {
            int _type = T__40;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVideoGen.g:36:7: ( 'size' )
            // InternalVideoGen.g:36:9: 'size'
            {
            match("size"); 
    ...
    public final void mT__41() throws RecognitionException {
        try {
            int _type = T__41;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVideoGen.g:37:7: ( 'color' )
            // InternalVideoGen.g:37:9: 'color'
            {
            match("color"); 
    ...
    public final void mRULE_LEFT_BRACKET() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVideoGen.g:3413:19: ( '{' )
            // InternalVideoGen.g:3413:21: '{'
            {
            match('{'); 
    ...
    public final void mRULE_RIGHT_BRACKET() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVideoGen.g:3415:20: ( '}' )
            // InternalVideoGen.g:3415:22: '}'
            {
            match('}'); 
    ...
    public final void mRULE_PERCENTAGE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVideoGen.g:3417:17: ( ( '1' .. '9' ( '0' .. '9' )? | '100' ) )
            // InternalVideoGen.g:3417:19: ( '1' .. '9' ( '0' .. '9' )? | '100' )
            {
            // InternalVideoGen.g:3417:19: ( '1' .. '9' ( '0' .. '9' )? | '100' )
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // InternalVideoGen.g:3417:20: '1' .. '9' ( '0' .. '9' )?
                    {
                    matchRange('1','9'); 
                    // InternalVideoGen.g:3417:29: ( '0' .. '9' )?
                    int alt1=2;
                    ...
                    switch (alt1) {
                        case 1 :
                            // InternalVideoGen.g:3417:30: '0' .. '9'
                            {
                            matchRange('0','9'); 
                    ...
                    break;
                case 2 :
                    // InternalVideoGen.g:3417:41: '100'
                    {
                    match("100"); 
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVideoGen.g:3419:12: ( RULE_INT '.' RULE_INT )
            // InternalVideoGen.g:3419:14: RULE_INT '.' RULE_INT
            {
            mRULE_INT(); 
            match('.'); 
            mRULE_INT(); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVideoGen.g:3421:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalVideoGen.g:3421:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalVideoGen.g:3421:11: ( '^' )?
            int alt3=2;
            ...
            // InternalVideoGen.g:3421:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVideoGen.g:3423:10: ( ( '0' .. '9' )+ )
            // InternalVideoGen.g:3423:12: ( '0' .. '9' )+
            {
            // InternalVideoGen.g:3423:12: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
            do {
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalVideoGen.g:3423:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVideoGen.g:3425:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalVideoGen.g:3425:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalVideoGen.g:3425:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalVideoGen.g:3425:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalVideoGen.g:3425:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalVideoGen.g:3425:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalVideoGen.g:3425:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVideoGen.g:3427:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalVideoGen.g:3427:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalVideoGen.g:3427:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVideoGen.g:3429:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalVideoGen.g:3429:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalVideoGen.g:3429:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVideoGen.g:3431:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalVideoGen.g:3431:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalVideoGen.g:3431:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalVideoGen.g:3433:16: ( . )
            // InternalVideoGen.g:3433:18: .
            {
            matchAny(); 
    ...
    static final String DFA14_acceptS =
        "\24\uffff\1\37\1\40\4\uffff\1\43\3\uffff\1\50\1\51\1\uffff\1\43\3\uffff\1\4\2\uffff\1\6\1\uffff\1\11\1\12\1\13\7\uffff\1\34\11\uffff\1\37\1\40\1\uffff\1\41\1\uffff\1\42\1\44\1\uffff\1\45\1\46\1\47\1\50\31\uffff\1\1\42\uffff\1\27\6\uffff\1\36\2\uffff\1\32\12\uffff\1\17\10\uffff\1\33\1\uffff\1\2\1\3\15\uffff\1\26\1\uffff\1\35\7\uffff\1\20\5\uffff\1\30\1\uffff\1\7\1\22\1\10\1\uffff\1\15\2\uffff\1\23\2\uffff\1\31\1\uffff\1\14\4\uffff\1\5\1\uffff\1\21\3\uffff\1\25\1\24\1\16";
