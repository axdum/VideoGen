...
public class InternalVideoGenParser extends AbstractInternalContentAssistParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_LEFT_BRACKET", "RULE_RIGHT_BRACKET", "RULE_STRING", "RULE_ID", "RULE_INT", "RULE_PERCENTAGE", "RULE_FLOAT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'TOP'", "'BOTTOM'", "'CENTER'", "'h'", "'horizontal'", "'v'", "'vertical'", "'VideoGen'", "'@author'", "'@version'", "'@creation'", "'mandatory'", "'optional'", "'alternatives'", "'image'", "'toptext'", "'bottomtext'", "'videoseq'", "'duration'", "'probability'", "'description'", "'filter'", "'text'", "'content'", "'position'", "'size'", "'color'", "'b&w'", "'negate'", "'flip'"
    };
    ...
    // InternalVideoGen.g:2693:1: rule__Text__Group__6__Impl : ( 'size' ) ;
    public final void rule__Text__Group__6__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2697:1: ( ( 'size' ) )
            // InternalVideoGen.g:2698:1: ( 'size' )
            {
            // InternalVideoGen.g:2698:1: ( 'size' )
            // InternalVideoGen.g:2699:2: 'size'
            {
             before(grammarAccess.getTextAccess().getSizeKeyword_6()); 
            match(input,40,FOLLOW_2); 
             after(grammarAccess.getTextAccess().getSizeKeyword_6()); 
    ...
    // InternalVideoGen.g:2708:1: rule__Text__Group__7 : rule__Text__Group__7__Impl rule__Text__Group__8 ;
    public final void rule__Text__Group__7() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2712:1: ( rule__Text__Group__7__Impl rule__Text__Group__8 )
            // InternalVideoGen.g:2713:2: rule__Text__Group__7__Impl rule__Text__Group__8
            {
            pushFollow(FOLLOW_6);
    ...
    // InternalVideoGen.g:2720:1: rule__Text__Group__7__Impl : ( ( rule__Text__SizeAssignment_7 ) ) ;
    public final void rule__Text__Group__7__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2724:1: ( ( ( rule__Text__SizeAssignment_7 ) ) )
            // InternalVideoGen.g:2725:1: ( ( rule__Text__SizeAssignment_7 ) )
            {
            // InternalVideoGen.g:2725:1: ( ( rule__Text__SizeAssignment_7 ) )
            // InternalVideoGen.g:2726:2: ( rule__Text__SizeAssignment_7 )
            {
             before(grammarAccess.getTextAccess().getSizeAssignment_7()); 
            // InternalVideoGen.g:2727:2: ( rule__Text__SizeAssignment_7 )
            // InternalVideoGen.g:2727:3: rule__Text__SizeAssignment_7
            {
            pushFollow(FOLLOW_2);
            rule__Text__SizeAssignment_7();
            ...
            state._fsp--;
             ...
             after(grammarAccess.getTextAccess().getSizeAssignment_7()); 
    ...
    // InternalVideoGen.g:2735:1: rule__Text__Group__8 : rule__Text__Group__8__Impl ;
    public final void rule__Text__Group__8() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2739:1: ( rule__Text__Group__8__Impl )
            // InternalVideoGen.g:2740:2: rule__Text__Group__8__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalVideoGen.g:2746:1: rule__Text__Group__8__Impl : ( RULE_RIGHT_BRACKET ) ;
    public final void rule__Text__Group__8__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2750:1: ( ( RULE_RIGHT_BRACKET ) )
            // InternalVideoGen.g:2751:1: ( RULE_RIGHT_BRACKET )
            {
            // InternalVideoGen.g:2751:1: ( RULE_RIGHT_BRACKET )
            // InternalVideoGen.g:2752:2: RULE_RIGHT_BRACKET
            {
             before(grammarAccess.getTextAccess().getRIGHT_BRACKETTerminalRuleCall_8()); 
            match(input,RULE_RIGHT_BRACKET,FOLLOW_2); 
             after(grammarAccess.getTextAccess().getRIGHT_BRACKETTerminalRuleCall_8()); 
    ...
    // InternalVideoGen.g:2762:1: rule__Text__Group_5__0 : rule__Text__Group_5__0__Impl rule__Text__Group_5__1 ;
    public final void rule__Text__Group_5__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2766:1: ( rule__Text__Group_5__0__Impl rule__Text__Group_5__1 )
            // InternalVideoGen.g:2767:2: rule__Text__Group_5__0__Impl rule__Text__Group_5__1
            {
            pushFollow(FOLLOW_10);
    ...
    // InternalVideoGen.g:2774:1: rule__Text__Group_5__0__Impl : ( 'color' ) ;
    public final void rule__Text__Group_5__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2778:1: ( ( 'color' ) )
            // InternalVideoGen.g:2779:1: ( 'color' )
            {
            // InternalVideoGen.g:2779:1: ( 'color' )
            // InternalVideoGen.g:2780:2: 'color'
            {
    ...
    // InternalVideoGen.g:2789:1: rule__Text__Group_5__1 : rule__Text__Group_5__1__Impl ;
    public final void rule__Text__Group_5__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2793:1: ( rule__Text__Group_5__1__Impl )
            // InternalVideoGen.g:2794:2: rule__Text__Group_5__1__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalVideoGen.g:2800:1: rule__Text__Group_5__1__Impl : ( ( rule__Text__ColorAssignment_5_1 ) ) ;
    public final void rule__Text__Group_5__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2804:1: ( ( ( rule__Text__ColorAssignment_5_1 ) ) )
            // InternalVideoGen.g:2805:1: ( ( rule__Text__ColorAssignment_5_1 ) )
            {
            // InternalVideoGen.g:2805:1: ( ( rule__Text__ColorAssignment_5_1 ) )
            // InternalVideoGen.g:2806:2: ( rule__Text__ColorAssignment_5_1 )
            {
             before(grammarAccess.getTextAccess().getColorAssignment_5_1()); 
            // InternalVideoGen.g:2807:2: ( rule__Text__ColorAssignment_5_1 )
            // InternalVideoGen.g:2807:3: rule__Text__ColorAssignment_5_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalVideoGen.g:2816:1: rule__BlackWhiteFilter__Group__0 : rule__BlackWhiteFilter__Group__0__Impl rule__BlackWhiteFilter__Group__1 ;
    public final void rule__BlackWhiteFilter__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2820:1: ( rule__BlackWhiteFilter__Group__0__Impl rule__BlackWhiteFilter__Group__1 )
            // InternalVideoGen.g:2821:2: rule__BlackWhiteFilter__Group__0__Impl rule__BlackWhiteFilter__Group__1
            {
            pushFollow(FOLLOW_22);
    ...
    // InternalVideoGen.g:2828:1: rule__BlackWhiteFilter__Group__0__Impl : ( () ) ;
    public final void rule__BlackWhiteFilter__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2832:1: ( ( () ) )
            // InternalVideoGen.g:2833:1: ( () )
            {
            // InternalVideoGen.g:2833:1: ( () )
            // InternalVideoGen.g:2834:2: ()
            {
             before(grammarAccess.getBlackWhiteFilterAccess().getBlackWhiteFilterAction_0()); 
            // InternalVideoGen.g:2835:2: ()
            // InternalVideoGen.g:2835:3: 
            {
            }
    ...
    // InternalVideoGen.g:2843:1: rule__BlackWhiteFilter__Group__1 : rule__BlackWhiteFilter__Group__1__Impl ;
    public final void rule__BlackWhiteFilter__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2847:1: ( rule__BlackWhiteFilter__Group__1__Impl )
            // InternalVideoGen.g:2848:2: rule__BlackWhiteFilter__Group__1__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalVideoGen.g:2854:1: rule__BlackWhiteFilter__Group__1__Impl : ( 'b&w' ) ;
    public final void rule__BlackWhiteFilter__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2858:1: ( ( 'b&w' ) )
            // InternalVideoGen.g:2859:1: ( 'b&w' )
            {
            // InternalVideoGen.g:2859:1: ( 'b&w' )
            // InternalVideoGen.g:2860:2: 'b&w'
            {
    ...
    // InternalVideoGen.g:2870:1: rule__NegateFilter__Group__0 : rule__NegateFilter__Group__0__Impl rule__NegateFilter__Group__1 ;
    public final void rule__NegateFilter__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2874:1: ( rule__NegateFilter__Group__0__Impl rule__NegateFilter__Group__1 )
            // InternalVideoGen.g:2875:2: rule__NegateFilter__Group__0__Impl rule__NegateFilter__Group__1
            {
    ...
    // InternalVideoGen.g:2882:1: rule__NegateFilter__Group__0__Impl : ( () ) ;
    public final void rule__NegateFilter__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2886:1: ( ( () ) )
            // InternalVideoGen.g:2887:1: ( () )
            {
            // InternalVideoGen.g:2887:1: ( () )
            // InternalVideoGen.g:2888:2: ()
            {
             before(grammarAccess.getNegateFilterAccess().getNegateFilterAction_0()); 
            // InternalVideoGen.g:2889:2: ()
            // InternalVideoGen.g:2889:3: 
            {
            }
    ...
    // InternalVideoGen.g:2897:1: rule__NegateFilter__Group__1 : rule__NegateFilter__Group__1__Impl ;
    public final void rule__NegateFilter__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2901:1: ( rule__NegateFilter__Group__1__Impl )
            // InternalVideoGen.g:2902:2: rule__NegateFilter__Group__1__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalVideoGen.g:2908:1: rule__NegateFilter__Group__1__Impl : ( 'negate' ) ;
    public final void rule__NegateFilter__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2912:1: ( ( 'negate' ) )
            // InternalVideoGen.g:2913:1: ( 'negate' )
            {
            // InternalVideoGen.g:2913:1: ( 'negate' )
            // InternalVideoGen.g:2914:2: 'negate'
            {
    ...
    // InternalVideoGen.g:2924:1: rule__FlipFilter__Group__0 : rule__FlipFilter__Group__0__Impl rule__FlipFilter__Group__1 ;
    public final void rule__FlipFilter__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2928:1: ( rule__FlipFilter__Group__0__Impl rule__FlipFilter__Group__1 )
            // InternalVideoGen.g:2929:2: rule__FlipFilter__Group__0__Impl rule__FlipFilter__Group__1
            {
    ...
    // InternalVideoGen.g:2936:1: rule__FlipFilter__Group__0__Impl : ( 'flip' ) ;
    public final void rule__FlipFilter__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2940:1: ( ( 'flip' ) )
            // InternalVideoGen.g:2941:1: ( 'flip' )
            {
            // InternalVideoGen.g:2941:1: ( 'flip' )
            // InternalVideoGen.g:2942:2: 'flip'
            {
    ...
    // InternalVideoGen.g:2951:1: rule__FlipFilter__Group__1 : rule__FlipFilter__Group__1__Impl ;
    public final void rule__FlipFilter__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2955:1: ( rule__FlipFilter__Group__1__Impl )
            // InternalVideoGen.g:2956:2: rule__FlipFilter__Group__1__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalVideoGen.g:2962:1: rule__FlipFilter__Group__1__Impl : ( ( rule__FlipFilter__OrientationAssignment_1 ) ) ;
    public final void rule__FlipFilter__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2966:1: ( ( ( rule__FlipFilter__OrientationAssignment_1 ) ) )
            // InternalVideoGen.g:2967:1: ( ( rule__FlipFilter__OrientationAssignment_1 ) )
            {
            // InternalVideoGen.g:2967:1: ( ( rule__FlipFilter__OrientationAssignment_1 ) )
            // InternalVideoGen.g:2968:2: ( rule__FlipFilter__OrientationAssignment_1 )
            {
             before(grammarAccess.getFlipFilterAccess().getOrientationAssignment_1()); 
            // InternalVideoGen.g:2969:2: ( rule__FlipFilter__OrientationAssignment_1 )
            // InternalVideoGen.g:2969:3: rule__FlipFilter__OrientationAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalVideoGen.g:2978:1: rule__VideoGeneratorModel__InformationAssignment_1 : ( ruleVideoGenInformation ) ;
    public final void rule__VideoGeneratorModel__InformationAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2982:1: ( ( ruleVideoGenInformation ) )
            // InternalVideoGen.g:2983:2: ( ruleVideoGenInformation )
            {
            // InternalVideoGen.g:2983:2: ( ruleVideoGenInformation )
            // InternalVideoGen.g:2984:3: ruleVideoGenInformation
            {
    ...
    // InternalVideoGen.g:2993:1: rule__VideoGeneratorModel__MediasAssignment_4 : ( ruleMedia ) ;
    public final void rule__VideoGeneratorModel__MediasAssignment_4() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:2997:1: ( ( ruleMedia ) )
            // InternalVideoGen.g:2998:2: ( ruleMedia )
            {
            // InternalVideoGen.g:2998:2: ( ruleMedia )
            // InternalVideoGen.g:2999:3: ruleMedia
            {
    ...
    // InternalVideoGen.g:3008:1: rule__VideoGenInformation__AuthorNameAssignment_1_1 : ( RULE_STRING ) ;
    public final void rule__VideoGenInformation__AuthorNameAssignment_1_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3012:1: ( ( RULE_STRING ) )
            // InternalVideoGen.g:3013:2: ( RULE_STRING )
            {
            // InternalVideoGen.g:3013:2: ( RULE_STRING )
            // InternalVideoGen.g:3014:3: RULE_STRING
            {
    ...
    // InternalVideoGen.g:3023:1: rule__VideoGenInformation__VersionAssignment_2_1 : ( RULE_STRING ) ;
    public final void rule__VideoGenInformation__VersionAssignment_2_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3027:1: ( ( RULE_STRING ) )
            // InternalVideoGen.g:3028:2: ( RULE_STRING )
            {
            // InternalVideoGen.g:3028:2: ( RULE_STRING )
            // InternalVideoGen.g:3029:3: RULE_STRING
            {
    ...
    // InternalVideoGen.g:3038:1: rule__VideoGenInformation__CreationDateAssignment_3_1 : ( RULE_STRING ) ;
    public final void rule__VideoGenInformation__CreationDateAssignment_3_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3042:1: ( ( RULE_STRING ) )
            // InternalVideoGen.g:3043:2: ( RULE_STRING )
            {
            // InternalVideoGen.g:3043:2: ( RULE_STRING )
            // InternalVideoGen.g:3044:3: RULE_STRING
            {
    ...
    // InternalVideoGen.g:3053:1: rule__MandatoryImage__DescriptionAssignment_1 : ( ruleImageDescription ) ;
    public final void rule__MandatoryImage__DescriptionAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3057:1: ( ( ruleImageDescription ) )
            // InternalVideoGen.g:3058:2: ( ruleImageDescription )
            {
            // InternalVideoGen.g:3058:2: ( ruleImageDescription )
            // InternalVideoGen.g:3059:3: ruleImageDescription
            {
    ...
    // InternalVideoGen.g:3068:1: rule__OptionalImage__DescriptionAssignment_1 : ( ruleImageDescription ) ;
    public final void rule__OptionalImage__DescriptionAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3072:1: ( ( ruleImageDescription ) )
            // InternalVideoGen.g:3073:2: ( ruleImageDescription )
            {
            // InternalVideoGen.g:3073:2: ( ruleImageDescription )
            // InternalVideoGen.g:3074:3: ruleImageDescription
            {
    ...
    // InternalVideoGen.g:3083:1: rule__AlternativeImage__ImageidAssignment_1 : ( RULE_ID ) ;
    public final void rule__AlternativeImage__ImageidAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3087:1: ( ( RULE_ID ) )
            // InternalVideoGen.g:3088:2: ( RULE_ID )
            {
            // InternalVideoGen.g:3088:2: ( RULE_ID )
            // InternalVideoGen.g:3089:3: RULE_ID
            {
    ...
    // InternalVideoGen.g:3098:1: rule__AlternativeImage__ImagesAssignment_3 : ( ruleImageDescription ) ;
    public final void rule__AlternativeImage__ImagesAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3102:1: ( ( ruleImageDescription ) )
            // InternalVideoGen.g:3103:2: ( ruleImageDescription )
            {
            // InternalVideoGen.g:3103:2: ( ruleImageDescription )
            // InternalVideoGen.g:3104:3: ruleImageDescription
            {
    ...
    // InternalVideoGen.g:3113:1: rule__ImageDescription__ImageidAssignment_1 : ( RULE_ID ) ;
    public final void rule__ImageDescription__ImageidAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3117:1: ( ( RULE_ID ) )
            // InternalVideoGen.g:3118:2: ( RULE_ID )
            {
            // InternalVideoGen.g:3118:2: ( RULE_ID )
            // InternalVideoGen.g:3119:3: RULE_ID
            {
    ...
    // InternalVideoGen.g:3128:1: rule__ImageDescription__LocationAssignment_2 : ( RULE_STRING ) ;
    public final void rule__ImageDescription__LocationAssignment_2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3132:1: ( ( RULE_STRING ) )
            // InternalVideoGen.g:3133:2: ( RULE_STRING )
            {
            // InternalVideoGen.g:3133:2: ( RULE_STRING )
            // InternalVideoGen.g:3134:3: RULE_STRING
            {
    ...
    // InternalVideoGen.g:3143:1: rule__ImageDescription__TopAssignment_3_1_1 : ( RULE_STRING ) ;
    public final void rule__ImageDescription__TopAssignment_3_1_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3147:1: ( ( RULE_STRING ) )
            // InternalVideoGen.g:3148:2: ( RULE_STRING )
            {
            // InternalVideoGen.g:3148:2: ( RULE_STRING )
            // InternalVideoGen.g:3149:3: RULE_STRING
            {
    ...
    // InternalVideoGen.g:3158:1: rule__ImageDescription__BottomAssignment_3_2_1 : ( RULE_STRING ) ;
    public final void rule__ImageDescription__BottomAssignment_3_2_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3162:1: ( ( RULE_STRING ) )
            // InternalVideoGen.g:3163:2: ( RULE_STRING )
            {
            // InternalVideoGen.g:3163:2: ( RULE_STRING )
            // InternalVideoGen.g:3164:3: RULE_STRING
            {
    ...
    // InternalVideoGen.g:3173:1: rule__MandatoryVideoSeq__DescriptionAssignment_1 : ( ruleVideoDescription ) ;
    public final void rule__MandatoryVideoSeq__DescriptionAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3177:1: ( ( ruleVideoDescription ) )
            // InternalVideoGen.g:3178:2: ( ruleVideoDescription )
            {
            // InternalVideoGen.g:3178:2: ( ruleVideoDescription )
            // InternalVideoGen.g:3179:3: ruleVideoDescription
            {
    ...
    // InternalVideoGen.g:3188:1: rule__OptionalVideoSeq__DescriptionAssignment_1 : ( ruleVideoDescription ) ;
    public final void rule__OptionalVideoSeq__DescriptionAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3192:1: ( ( ruleVideoDescription ) )
            // InternalVideoGen.g:3193:2: ( ruleVideoDescription )
            {
            // InternalVideoGen.g:3193:2: ( ruleVideoDescription )
            // InternalVideoGen.g:3194:3: ruleVideoDescription
            {
    ...
    // InternalVideoGen.g:3203:1: rule__AlternativeVideoSeq__VideoidAssignment_1 : ( RULE_ID ) ;
    public final void rule__AlternativeVideoSeq__VideoidAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3207:1: ( ( RULE_ID ) )
            // InternalVideoGen.g:3208:2: ( RULE_ID )
            {
            // InternalVideoGen.g:3208:2: ( RULE_ID )
            // InternalVideoGen.g:3209:3: RULE_ID
            {
    ...
    // InternalVideoGen.g:3218:1: rule__AlternativeVideoSeq__VideodescsAssignment_3 : ( ruleVideoDescription ) ;
    public final void rule__AlternativeVideoSeq__VideodescsAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3222:1: ( ( ruleVideoDescription ) )
            // InternalVideoGen.g:3223:2: ( ruleVideoDescription )
            {
            // InternalVideoGen.g:3223:2: ( ruleVideoDescription )
            // InternalVideoGen.g:3224:3: ruleVideoDescription
            {
    ...
    // InternalVideoGen.g:3233:1: rule__VideoDescription__VideoidAssignment_1 : ( RULE_ID ) ;
    public final void rule__VideoDescription__VideoidAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3237:1: ( ( RULE_ID ) )
            // InternalVideoGen.g:3238:2: ( RULE_ID )
            {
            // InternalVideoGen.g:3238:2: ( RULE_ID )
            // InternalVideoGen.g:3239:3: RULE_ID
            {
    ...
    // InternalVideoGen.g:3248:1: rule__VideoDescription__LocationAssignment_2 : ( RULE_STRING ) ;
    public final void rule__VideoDescription__LocationAssignment_2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3252:1: ( ( RULE_STRING ) )
            // InternalVideoGen.g:3253:2: ( RULE_STRING )
            {
            // InternalVideoGen.g:3253:2: ( RULE_STRING )
            // InternalVideoGen.g:3254:3: RULE_STRING
            {
    ...
    // InternalVideoGen.g:3263:1: rule__VideoDescription__DurationAssignment_3_1_1 : ( RULE_INT ) ;
    public final void rule__VideoDescription__DurationAssignment_3_1_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3267:1: ( ( RULE_INT ) )
            // InternalVideoGen.g:3268:2: ( RULE_INT )
            {
            // InternalVideoGen.g:3268:2: ( RULE_INT )
            // InternalVideoGen.g:3269:3: RULE_INT
            {
    ...
    // InternalVideoGen.g:3278:1: rule__VideoDescription__ProbabilityAssignment_3_2_1 : ( RULE_PERCENTAGE ) ;
    public final void rule__VideoDescription__ProbabilityAssignment_3_2_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3282:1: ( ( RULE_PERCENTAGE ) )
            // InternalVideoGen.g:3283:2: ( RULE_PERCENTAGE )
            {
            // InternalVideoGen.g:3283:2: ( RULE_PERCENTAGE )
            // InternalVideoGen.g:3284:3: RULE_PERCENTAGE
            {
    ...
    // InternalVideoGen.g:3293:1: rule__VideoDescription__DescriptionAssignment_3_3_1 : ( RULE_STRING ) ;
    public final void rule__VideoDescription__DescriptionAssignment_3_3_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3297:1: ( ( RULE_STRING ) )
            // InternalVideoGen.g:3298:2: ( RULE_STRING )
            {
            // InternalVideoGen.g:3298:2: ( RULE_STRING )
            // InternalVideoGen.g:3299:3: RULE_STRING
            {
    ...
    // InternalVideoGen.g:3308:1: rule__VideoDescription__FilterAssignment_3_4_1 : ( ruleFilter ) ;
    public final void rule__VideoDescription__FilterAssignment_3_4_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3312:1: ( ( ruleFilter ) )
            // InternalVideoGen.g:3313:2: ( ruleFilter )
            {
            // InternalVideoGen.g:3313:2: ( ruleFilter )
            // InternalVideoGen.g:3314:3: ruleFilter
            {
    ...
    // InternalVideoGen.g:3323:1: rule__VideoDescription__TextAssignment_3_5_1 : ( ruleText ) ;
    public final void rule__VideoDescription__TextAssignment_3_5_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3327:1: ( ( ruleText ) )
            // InternalVideoGen.g:3328:2: ( ruleText )
            {
            // InternalVideoGen.g:3328:2: ( ruleText )
            // InternalVideoGen.g:3329:3: ruleText
            {
    ...
    // InternalVideoGen.g:3338:1: rule__Text__ContentAssignment_2 : ( RULE_STRING ) ;
    public final void rule__Text__ContentAssignment_2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3342:1: ( ( RULE_STRING ) )
            // InternalVideoGen.g:3343:2: ( RULE_STRING )
            {
            // InternalVideoGen.g:3343:2: ( RULE_STRING )
            // InternalVideoGen.g:3344:3: RULE_STRING
            {
    ...
    // InternalVideoGen.g:3353:1: rule__Text__PositionAssignment_4 : ( rulePosition ) ;
    public final void rule__Text__PositionAssignment_4() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3357:1: ( ( rulePosition ) )
            // InternalVideoGen.g:3358:2: ( rulePosition )
            {
            // InternalVideoGen.g:3358:2: ( rulePosition )
            // InternalVideoGen.g:3359:3: rulePosition
            {
    ...
    // InternalVideoGen.g:3368:1: rule__Text__ColorAssignment_5_1 : ( RULE_STRING ) ;
    public final void rule__Text__ColorAssignment_5_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3372:1: ( ( RULE_STRING ) )
            // InternalVideoGen.g:3373:2: ( RULE_STRING )
            {
            // InternalVideoGen.g:3373:2: ( RULE_STRING )
            // InternalVideoGen.g:3374:3: RULE_STRING
            {
    ...
    // $ANTLR start "rule__Text__SizeAssignment_7"
    // InternalVideoGen.g:3383:1: rule__Text__SizeAssignment_7 : ( RULE_INT ) ;
    public final void rule__Text__SizeAssignment_7() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3387:1: ( ( RULE_INT ) )
            // InternalVideoGen.g:3388:2: ( RULE_INT )
            {
            // InternalVideoGen.g:3388:2: ( RULE_INT )
            // InternalVideoGen.g:3389:3: RULE_INT
            {
             before(grammarAccess.getTextAccess().getSizeINTTerminalRuleCall_7_0()); 
            match(input,RULE_INT,FOLLOW_2); 
             after(grammarAccess.getTextAccess().getSizeINTTerminalRuleCall_7_0()); 
    ...
    // $ANTLR end "rule__Text__SizeAssignment_7"


    // $ANTLR start "rule__FlipFilter__OrientationAssignment_1"
    // InternalVideoGen.g:3398:1: rule__FlipFilter__OrientationAssignment_1 : ( ( rule__FlipFilter__OrientationAlternatives_1_0 ) ) ;
    public final void rule__FlipFilter__OrientationAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalVideoGen.g:3402:1: ( ( ( rule__FlipFilter__OrientationAlternatives_1_0 ) ) )
            // InternalVideoGen.g:3403:2: ( ( rule__FlipFilter__OrientationAlternatives_1_0 ) )
            {
            // InternalVideoGen.g:3403:2: ( ( rule__FlipFilter__OrientationAlternatives_1_0 ) )
            // InternalVideoGen.g:3404:3: ( rule__FlipFilter__OrientationAlternatives_1_0 )
            {
             before(grammarAccess.getFlipFilterAccess().getOrientationAlternatives_1_0()); 
            // InternalVideoGen.g:3405:3: ( rule__FlipFilter__OrientationAlternatives_1_0 )
            // InternalVideoGen.g:3405:4: rule__FlipFilter__OrientationAlternatives_1_0
            {
            pushFollow(FOLLOW_2);
